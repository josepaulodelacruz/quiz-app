...
class ShowArticleScreen extends StatelessWidget {
  ...
  ShowArticleScreen({Key? key, this.index})
      : super(key: key);
      ...
      body: BlocListener<AdsBloc, AdsState>(
        listener: (context, state) {
          if(state.status == AdsStatus.loading) {
            ...
            Navigator.pushNamed(context, read_article, arguments: ScreenArguments(
                article: BlocProvider.of<ArticlesBloc>(context).state.currentRead));
          }
        },
